...
public class SpinnerAndShooter extends SubsystemBase {
  ...
  public boolean isAtSpeed() {
    return Math.abs(getLeftRPS() - Constants.Spin.TestTargetRPS)
            < Constants.Spin.ShooterToleranceRPS
        && Math.abs(getRightRPS() - Constants.Spin.TestTargetRPS)
            < Constants.Spin.ShooterToleranceRPS;
  }
  ...
  public void periodic() {
    ...
    boolean atSpeed =
        Math.abs(leftRPS - Constants.Spin.TestTargetRPS) < Constants.Spin.ShooterToleranceRPS
            && Math.abs(rightRPS - Constants.Spin.TestTargetRPS)
                < Constants.Spin.ShooterToleranceRPS;
