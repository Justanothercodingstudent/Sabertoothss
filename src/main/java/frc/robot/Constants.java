...
public final class Constants {
  ...
  public static class TeamDependentFactors {
    ...
    // private static final SendableChooser<TeamColorSelection> teamColorChooser =
    // buildTeamColorChooser();
    // public static boolean redTeam = DriverStation.getAlliance().orElse(Alliance.Blue) ==
    // Alliance.Red;
    ...
    public static final double[] redHubTagIds = {1, 2, 3, 4, 5, 8, 9, 10, 11};

    public static final double[] blueHubTagIds = {18, 19, 20, 21, 24, 25, 26, 27};
  ...
  public static class LimelightConstants {
    ...
    public static final CameraConfig frontCamera =
        new CameraConfig("limelight-front", "Front Limelight", 0.3175, 0.0635, 0.3048, 180.0);

    public static final CameraConfig rearCamera =
        new CameraConfig("limelight-left", "left Limelight", 0, 0, 0, 0.0);
    ...
    public static final double visionSpeedTrustGateMetersPerSecond = 1.0;
    public static final double visionOmegaTrustGateDegreesPerSecond = 60.0;
    public static final double highSpeedVisionStdDevMultiplier = 1.35;
    public static final double slowSpeedVisionStdDevMultiplier = 0.70;
    public static final double highSpeedPoseDeltaMultiplier = 0.75;
    public static final double slowSpeedPoseDeltaMultiplier = 1.60;
  ...
  public static final class Intake {
    ...
    public static final double maxExtend = 14.1;
  ...
  public static final class Spin {
    ...
    public static final double LeftSideShooterkP =
        0.62; // was .6  Causes Osscilation error if sent to 0 from  PID Needs ~.3 to run to 0
    ...
    public static final double RightSideShooterkP =
        0.62; // Causes Osscilation error if sent to 0 from PID Needs ~.3 to run to 0
