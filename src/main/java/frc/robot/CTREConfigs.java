...
public final class CTREConfigs {
  ...
  public CTREConfigs() {
    ...
    swerveAngleFXConfig.CurrentLimits.SupplyCurrentLimitEnable =
        Constants.Swerve.angleEnableCurrentLimit; // enables supplycurrentlimit
    swerveAngleFXConfig.CurrentLimits.SupplyCurrentLimit =
        Constants.Swerve.angleCurrentLimit; // Max SupplyCurrentLimit
    swerveAngleFXConfig.CurrentLimits.SupplyCurrentLowerLimit =
        Constants.Swerve.angleCurrentThreshold; // Minimum SuplyCurrentLimit
    swerveAngleFXConfig.CurrentLimits.SupplyCurrentLowerTime =
        Constants.Swerve
            .angleCurrentThresholdTime; // Duration of Supply Current at max until it needs to drop
    // to the Lower Limit
    ...
    swerveDriveFXConfig.CurrentLimits.SupplyCurrentLowerLimit =
        Constants.Swerve
            .driveCurrentThreshold; // Lower Limit can't be higher than Current Limit which needs to
    // be changed
    swerveDriveFXConfig.CurrentLimits.SupplyCurrentLowerTime =
        Constants.Swerve
            .driveCurrentThresholdTime; // Time must be adjusted for the duration of the Lowered
    // Limittation of the supply current
